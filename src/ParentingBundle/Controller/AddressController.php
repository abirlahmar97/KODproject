...
class AddressController extends Controller
{
    ...
    public function readAction()
    {
        ...
        return $this->render('@Parenting/Address/read.html.twig', array("addresses" => $addresses
    ...
    public function updateAction($id,Request $request)
    {
        ...
        return $this->render("@Parenting/Address/update.html.twig",array('form'=>$Form->createView()));
    }
   public function mapAction()
   {
    ...
    public function moreAction(Request $request,$id)
    {
        ...
        $em->persist($address);
        $em->flush();
        //Afficher les catégories d'adresses disponibles
        $categories=$em->getRepository("ShopBundle:Category")->findAddress();
        //Google maps
        $Latitudes= $address->getLat();
        $Longitudes=$address->getLng();
        dump($Longitudes);
        ...
        return $this->render('@Parenting/Address/more.html.twig', array('address'=>$address,'categories'=>$categories,'Latitudes'=>$Latitudes,'Longitudes'=>$Longitudes));
    }
    public function showbyCategoryAction($category)
    {
        ...
        return $this->render('@Parenting/Address/readCa.html.twig', array( "addresses" => $addresses,'user' => $this->getUser()
